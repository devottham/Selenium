...
public class TestCase4 
{
    public static void main(String[] args) throws Exception 
    {
        ...
        Thread.sleep(2000);
        driver.findElement(By.id("rc_select_4")).sendKeys("Software Engineer");
        driver.findElement(By.id("rc_select_4")).sendKeys(Keys.ENTER);
        driver.findElement(By.xpath("//span[text()='Save']")).click();
        Thread.sleep(3000);
        driver.findElement(By.xpath("//span[text()='Filter Employees']")).click();
        Thread.sleep(2000);
        driver.findElement(By.id("rc_select_9")).sendKeys("Head Office");
        driver.findElement(By.id("rc_select_9")).sendKeys(Keys.ENTER);
        driver.findElement(By.xpath("//span[text()='Save']")).click();
        Thread.sleep(3000);
